...
%  save(fenergy,'Estore')
%loglog(500:length(T),real(energy(500:length(T),1)-E0)/N,'Color',CD{count},'LineWidth',3)

loglog(1:length(T),(real(energy(:,1)-E0)/N),'Color',CD{count},'LineWidth',3)
hold on
% subplot(3,1,2)
...
%exportgraphics(f,'MFIdifferentsystemsizeFQA3.jpg')
toc
