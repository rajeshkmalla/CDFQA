...
BETA=[0.0025,0.005,0.01,0.02];
for k=1:4
    count=count+1;
    N=6;
    alpha=1;beta=(6/N);gamma=beta;
...
loglog((1:length(T))*k1,(real(energy(:,1)-E0)/N),'Color',CD{k},'LineWidth',3)
...
%exportgraphics(f,'MFIdifferentdeltat3.jpg')
toc