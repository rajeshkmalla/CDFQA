...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
subplot(1,3,1)
plot(T,real(energy(:,1))/EE(1),'Color',CD{FalqonCD+1},'LineWidth',2)
hold on
ax1=gca;
xlabel('Time')
ylabel('Energy')
hold on
subplot(1,3,2)
plot(T,real(Beta(:,1)),'Color',CD{FalqonCD+1},'LineWidth',2)
hold on
...
subplot(1,3,3)
if FalqonCD==1
plot(T,real(Gamma1(:,1)),'Color',CD{FalqonCD+1},'LineWidth',2)
...
hold on
 ...
 plot(T,real(Gamma2(:,1)),'Color',CD{FalqonCD+1},'LineWidth',2)
%plot(T,real(betadot(:,1)),'Color',CD{FalqonCD+2})
 ax4=gca;
xlabel('Time')
ylabel('Gamma(t)')
