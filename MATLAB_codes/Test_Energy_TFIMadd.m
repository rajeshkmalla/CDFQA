...
close all
%% Initialization
N=6;J=-1;hz=-0;hx=-1.4;perBC=1;% Hamiltonian parameters
...
HCD0=sparse(eye(2^N));
HCD1=HamOnsite(N,2,1)+0.5.*HamNN(N,2,3,1,perBC);
HCD2=HamNN(N,2,3,1,perBC);
HCD3=HamNN(N,2,1,1,perBC)+0.5.*HamNN(N,2,3,1,perBC)
...
grid on
%legend('I','Y','YZ','YX')
legend('I,Y,YX','Y+0.5YZ','YZ','YX+0.5YZ')
...
%exportgraphics(f,'Fig15/TFIM.jpg')


%%-------------------------------------------------
%%-------------------------------------------------
exportgraphics(f,'Fig15/TFIadd3.jpg')